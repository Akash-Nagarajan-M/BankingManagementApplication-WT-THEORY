...
public class Mypage2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField43 = new javax.swing.JPasswordField();
        jPanel8 = new javax.swing.JPanel();
        jLabel39 = new javax.swing.JLabel();
        jLabel40 = new javax.swing.JLabel();
        jButton15 = new javax.swing.JButton();
        jButton16 = new javax.swing.JButton();
        jTextField41 = new javax.swing.JPasswordField();
        jTextField42 = new javax.swing.JPasswordField();
        ...
        jTabbedPane1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 0, 51), 3, true));
        ...
        jTextField17.setMinimumSize(new java.awt.Dimension(120, 30));
        ...
        jTextField36.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N

        jTextField37.setEditable(false);
        jTextField37.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N

        jTextField38.setEditable(false);
        jTextField38.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N

        jTextField40.setEditable(false);
        jTextField40.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addGap(69, 69, 69))
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addComponent(jLabel41, javax.swing.GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jTextField38, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jTextField6, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 268, Short.MAX_VALUE)
        ...
        jLabel13.getAccessibleContext().setAccessibleName("Security \nQuestion");
        ...
        jButton18.setFont(new java.awt.Font("Liberation Sans", 1, 20)); // NOI18N
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        try {
            ...
            String acc_no = Mypage2.currentAccountNumber;
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        String user = Mypage2.currentAccountNumber;
        try {
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        try {
            ...
            String sql = "update Balances set Balance=" + String.valueOf(newBalance) + " where Acc=" + Mypage2.currentAccountNumber;
            System.out.println(sql);
            pst = conn.prepareStatement(sql);
            pst.execute();
            sql = "update Account set Balance=" + String.valueOf(newBalance) + " where Account=" + Mypage2.currentAccountNumber ;
            System.out.println(sql);
            pst = conn.prepareStatement(sql);
            pst.execute();
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        // TODO add your handling code here:
        try {
            String balance = jTextField30.getText();
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try{
            String sql="select * from Balances where Acc=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1,Mypage2.currentAccountNumber);
            rs=pst.executeQuery();
            if(rs.next())
            {
                String value1=rs.getString("Name");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        // TODO add your handling code here:
        try {
            String value1 = Mypage2.currentAccountNumber;
...
//        Table1();
    ...
    public static void setAuthenticatedAccountNumber(String accountNumber) {
        Mypage2.currentAccountNumber = accountNumber;
    }
...
//    }
    ...
    public void Table2() {
        try {
            String sql = "select Account,Name,MICR_No,Balance from Account where Account ="+Mypage2.currentAccountNumber;
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    public void Calendar() {
        ...
        jLabel14.setText(+day + "-" + (month + 1) + "-" + year);
    ...
    public void TransferD() {
        try {
            String val1 = Mypage2.currentAccountNumber;
            ...
            System.out.println("Text field with transfer d");
            JOptionPane.showMessageDialog(null, e);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mypage2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void setTextFieldsWithAccountNumber() {
        jLabel9.setText(currentAccountNumber);
        try {
            String sql = "select * from Balances where Acc=?";
            pst = conn.prepareStatement(sql);
            pst.setString(1, Mypage2.currentAccountNumber);
            ...
            if (rs.next()) {
                ...
                String value1 = rs.getString("Acc");

                jTextField21.setText(value1);
...
//            
            ...
            System.out.println("Text field with acc no");
            JOptionPane.showMessageDialog(null, e);
        } finally {
            try {
                rs.close();
    ...
    private javax.swing.JPasswordField jTextField41;
    private javax.swing.JPasswordField jTextField42;
    private javax.swing.JPasswordField jTextField43;
